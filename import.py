...
while date_use < date_final:
    ...
    if group_count>0:
        ...
        for i in use_names:
            ...
            if error_check==-1:
                ...
                win_weight_lb_f=""
                for i in win_weight_st:
                    win_weight_st_f=win_weight_lb_f+str(i)
                ...
                #extract all numeric values - has to be done due to variable length of weight value
                for i in win_weight_lb:
                    win_weight_lb_f=win_weight_lb_f+str(i)
                ...
                sec_weight_st_f=""
                for i in sec_weight_st:
                    sec_weight_st_f=sec_weight_st_f+str(i)
                ...
                sec_weight_lb_f=""
                for i in sec_weight_lb:
                    sec_weight_lb_f=sec_weight_lb_f+str(i)
    ...
    file_name=group_used+" "+str(start_date)+"-"+str(date_use)+" days1-10.csv"
